...
export default defineConfig({
  ...
  // styles fight the CSP below, whether or not any code block exists.
  ...
  security: {
    csp: {
      ...
      // attributes, and 'unsafe-inline' on `style-src` is nullified by the hashes
      // Astro appends there, so the allowance is scoped to `style-src-attr`,
      // leaving <style> and <link> under the strict policy.
      styleDirective: {
