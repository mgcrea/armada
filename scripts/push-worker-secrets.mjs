...
// unless told otherwise — so following those instructions would replace the LIVE
// webhook signing secret with a test-mode one, and every real payment would then
// be refused as an invalid signature with nothing anywhere saying why. Bastion
// learned that one; this is its script, copied.
//
...
// api.armada.mgcrea.io. Pushing a test-mode webhook secret there refuses every
